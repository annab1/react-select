...
var Select = _react2['default'].createClass({
	...
	propTypes: {
		...
		disableEnter: _react2['default'].PropTypes.bool // disables enter functionality
	},
	...
	handleMouseDown: function handleMouseDown(event) {
		...
		if (event.target.parentNode.className !== 'Select-input') {
	...
	closeMenu: function closeMenu() {
		this.setState({
			...
			inputValue: this.props.clearInputValue ? '' : this.state.inputValue
		});
	},
	...
	selectValue: function selectValue(value) {
		var inputValueToSet = this.props.clearInputValue ? '' : this.state.inputValue;
		if (this.props.multi) {
			this.addValue(value);
			this.setState({
				inputValue: inputValueToSet
			});
		} else {
			this.setValue(value);
			this.setState({
